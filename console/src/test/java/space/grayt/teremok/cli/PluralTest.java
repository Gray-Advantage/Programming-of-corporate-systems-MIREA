...
class PluralTest {
    ...
    @Test
    void отОдиннадцатиДоЧетырнадцатиФормаМножественная() {
    ...
    @Test
    void формыДругихСловПередаютсяЯвно() {
